...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form name="edit_blog" id="edit_blog" class="form-horizontal" action="<?php echo base_url('Super_admin/update_blog');?>" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                     ...
                     <div class="control-group">
                        <div class="controls">
                            <img src="<?= base_url($blog_info->blog_image); ?>" height="80px" width="100px" />
                        </div>
                    </div>

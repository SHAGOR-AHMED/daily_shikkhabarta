...
<html lang="en">
	<head>
		...
		<link href="<?php echo base_url('assets/admin/')."css/custom-admin.css"; ?>" type="text/css" rel="stylesheet">

		<!-- ace styles -->
		<link href="<?php echo base_url('assets/admin/')."css/ace.min.css"; ?>" type="text/css" rel="stylesheet">
		<link href="<?php echo base_url('assets/admin/')."css/ace-rtl.min.css"; ?>" type="text/css" rel="stylesheet">
	</head>
